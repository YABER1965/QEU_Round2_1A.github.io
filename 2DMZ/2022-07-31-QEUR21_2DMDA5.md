---
title: QEUR21_2DMDA5:　補足　～　６つのランドマーク(LANDMARK)を再び採用する
date: 2022-07-31
tags: ["QEUシステム", "メトリックス", "Python言語", "機械学習", "Pytorch", "ディープラーニング", "MAZE"]
excerpt: PythonとPytorchを使ったMAZEの強化学習
---

## QEUR21_2DMDA5:　補足　～　６つのランドマーク(LANDMARK)を再び採用する

## ～  う～ん・・・。もう一声！！  ～

QEU:FOUNDER ： “今回の解説は簡単に行こう。ＯＮＥＨＯＴの代わりに6つのメトリックスを使って次元削減しましょう。プラスRTメトリックスを使ってね・・・。”

![imageRL4-14-1](/2022-07-31-QEUR21_2DMDA5/imageRL4-14-1.png) 

D先生 : “FOUNDER・・・。BUMP変数も追加してください・・・。”

![imageRL4-14-2](/2022-07-31-QEUR21_2DMDA5/imageRL4-14-2.png) 
...
![imageRL4-14-3](/2022-07-31-QEUR21_2DMDA5/imageRL4-14-3.png) 

**（パフォーマンス推移）**

![imageRL4-14-4](/2022-07-31-QEUR21_2DMDA5/imageRL4-14-4.png) 
...
[![MOVIE2](http://img.youtube.com/vi/eET8JloFS5E/0.jpg)](http://www.youtube.com/watch?v=eET8JloFS5E "權朗 預言日本2023年大浩劫？｜日本國運運程預言｜香港易經占卜大師兔年最新預測，香港風水師名單，风水")

QEU:FOUNDER ： “ハァ？野次馬ねえ・・・。いろんな意味で、（J国は）近いうちに相当ひどくなると思うよ。”

D先生 : “すいません。タイトルが「向こうの言葉」で、私にはよくわかりません・・・。”

![imageRL4-14-5](/2022-07-31-QEUR21_2DMDA5/imageRL4-14-5.png) 

QEU:FOUNDER ： “D先生のせっかくのリクエストなのでタイトルを翻訳しましょう・・・。ドン！！”

D先生 : “（タイトルの意味を知って）キャー！！”

![imageRL4-14-6](/2022-07-31-QEUR21_2DMDA5/imageRL4-14-6.png) 

QEU:FOUNDER ： “現在の状況からみて、今後の経済が悪くなるというのは誰にでもいえますが・・・。”

![imageRL4-14-7](/2022-07-31-QEUR21_2DMDA5/imageRL4-14-7.png) 
