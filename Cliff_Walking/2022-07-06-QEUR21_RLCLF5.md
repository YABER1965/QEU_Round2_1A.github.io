---
title: QEUR21_RLCLF5 – 「崖歩き(Cliff_Walking)」をさらっと復習しましょう(その6)
date: 2022-07-06
...
class Agent():
    ...
    def get_episode(self, iCnt_play):
        ...
        number_state, a_row, a_col = calc_address(number_state)
        ...
        # ---------------------------
        # 状態(STATE_NEXT)を生成する
        state = np.hstack([number_state, [MH_dist, EuDist_S, EuDist_G]])
        ...
        while True:
            ...
            # 学習の進捗を表示する（一次元アドレスと二次元アドレスに変換する）
            number_state_next, a_row_next, a_col_next = calc_address(number_state_next)
            #print("iCnt_play:{}, iCnt_turn:{}, a_row:{}, a_col:{}, a_order:{}, reward:{}".format(iCnt_play, iCnt_turn, a_row, a_col, a_order, reward))
            ...
            # ---------------------------
            # 状態(STATE_NEXT)を生成する
            state_next = np.hstack([number_state_next, [MH_dist_next, EuDist_S_next, EuDist_G_next]])
...
![imageRL3-6-1](/2022-07-06-QEUR21_RMCLF5/imageRL3-6-1.jpg)

**（パフォーマンス推移）**

![imageRL3-6-2](/2022-07-06-QEUR21_RMCLF5/imageRL3-6-2.jpg)
...
![imageRL3-6-3](/2022-07-06-QEUR21_RMCLF5/imageRL3-6-3.jpg)
...
[![MOVIE2](http://img.youtube.com/vi/4MjQtkoJISc/0.jpg)](http://www.youtube.com/watch?v=4MjQtkoJISc "参院選終盤情勢を徹底分析！維新躍進、立憲惨敗、れいわは？ 7月10日夜、野党再編の号砲が鳴る")
